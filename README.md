...
|`INSTALL_JAVA16`| This executes a script which installs the Java 16 runtime if it isn't already installed. This version is needed for Minecraft version 1.17+ | `false` |
